            ...
            <Container>
                ...
                <div className="container">
                  ...
                  <h className="tabs-list">Research Interests</h>
                        ...
                        <h style={{ color: "#bcc4b7" }}> <u>Selected Certifications:</u></h>
                        <ul>
                            <li>
                                Coursera on Fundamentals of Digital Image and Video Processing Certified by Northwestern University. <a style={{ color:"#32a8a6"}}href="https://www.coursera.org/account/accomplishments/verify/JE5BXT6HBWYL?utm_source=link&utm_medium=certificate&utm_content=cert_image&utm_campaign=sharing_cta&utm_product=course" target="_blank"><i>Link</i></a>
                            </li>
                            <li>
                                Coursera on Front-End Web UI Frameworks and Tools: Bootstrap 4 Certified by Hong Kong University Of
                                Science And Technology. <a style={{ color:"#32a8a6"}}href="https://www.coursera.org/account/accomplishments/verify/P9QGGCGMB3DA?utm_source=link&utm_medium=certificate&utm_content=cert_image&utm_campaign=sharing_cta&utm_product=course" target="_blank"><i>Link</i></a>
                            </li>
                            <li>
                                Coursera on Programming Foundations with JavaScript, HTML and CSS Certified by Duke University. <a style={{ color:"#32a8a6"}}href="https://www.coursera.org/account/accomplishments/verify/8CT7BK7G9XQL?utm_source=link&utm_medium=certificate&utm_content=cert_image&utm_campaign=sharing_cta&utm_product=course" target="_blank"><i>Link</i></a>
                            </li>
                            <li>
                                Coursera on Build Your Portfolio Website with HTML and CSS Certified by Coursera Project Network. <a style={{ color:"#32a8a6"}}href="https://www.coursera.org/account/accomplishments/verify/R4MLRNUFTF96?utm_source=link&utm_medium=certificate&utm_content=cert_image&utm_campaign=sharing_cta&utm_product=project" target="_blank"><i>Link</i></a></li>
                            <li> Python Starter Pack Workshop Certified by MIST Innovation Club with support of e-learning partner ohubrihi
                                Online Courses. <a style={{ color:"#32a8a6"}}href="https://drive.google.com/file/d/1yzZqckoRtcd7wrn8t3jVamlPieexWH5b/view" target="_blank"><i>Link</i></a>

                            </li>
                            <li>Coursera on Python Data Structures certified by Coursera Project Network. <a style={{ color:"#32a8a6"}}href="https://www.coursera.org/account/accomplishments/verify/KBNXEBJPZ4R8?utm_source=link&utm_medium=certificate&utm_content=cert_image&utm_campaign=pdf_header_button&utm_product=project" target="_blank"><i>Link</i></a></li>
                            <li>Introduction to Flutter Development Using Dart Certified by The App Brewery. <a style={{ color:"#32a8a6"}}href="https://drive.google.com/file/d/1ZZfxpIc_e7bz2sU8oW7-WfOyYXvl2Aq7/view" target="_blank"><i>Link</i></a></li>
                        </ul>
...
<br/>
                        ...
                        <h style={{color: "yellowgreen", fontSize: 20}}><u>Internship </u></h>
                        <br/>
                        <br/>
                        <Row >
                            <Col xs={5} >
                    ...
                    <h className="tabs-list">Projects</h>
                        ...
                        <ul style={{ listStyleType: "circle" }}>
                            <li > Developed a website for remote sensing using IoT for a research group at the University of New Hampshire, New
                                Hampshire, United States. <i style={{ color: 'teal' }}>2022</i></li>
                            <li>Working on Sign Language Translation Module, Violence Detection Module and Film Censorship and Rating
                                Module. <i style={{ color: 'teal' }}>2021-Present</i></li>
                            <li>Demonstration of Frequency Handoff and Call drop for 2G and 3G networks. <i style={{ color: 'teal' }}>2021</i></li>
                            <li>Website for the 5th International Conference on Electrical Engineering and Information & Communication
                                Technology (ICEEICT) for the Military Institute of Science and Technology (MIST). <i style={{ color: 'teal' }}>2021</i></li>
                            <li> Advanced Elevator with overload alert system. <i style={{ color: 'teal' }}>2021</i></li>
                            <li>Implementation of Voice Signal Filtration and Identification using custom Frequency Factor based algorithm in
                                software-based attendance collection. <i style={{ color: 'teal' }}>2020</i></li>
                            <li>Soil moisture detection and Plant watering system using Arduino. <i style={{ color: 'teal' }}>2019</i> </li>
                        </ul>
